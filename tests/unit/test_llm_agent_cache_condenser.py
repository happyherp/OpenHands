...
@patch('openhands.memory.condenser.impl.llm_agent_cache_condenser.Message')
@patch('openhands.memory.condenser.impl.llm_agent_cache_condenser.TextContent')
def test_llm_agent_cache_condenser_condense_with_rewrite(mock_text_content, mock_message):
...
"""
    ...
    # Verify that the summary is set to the REWRITE content
    assert result.action.summary == "User asked about database schema and agent explained the tables and relationships."